...
-----
curl -s http://jacamo.sourceforge.net/nps/np07.sh -o np.sh
sh ./np.sh
-----

NOTE: `npss.sh` creates an application based on JaCaMo 0.7. You can replace it by `npss.sh` to create a JaCaMo application based on the current snap shot version.
