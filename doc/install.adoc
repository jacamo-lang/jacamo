...
We have different options to start using JaCaMo: shell script commands, Gradle, or Docker.

The shell script option require that you download and install JaCaMo in your machine.
...
----
> Task :run
JaCaMo 1.2 built on Wed Apr 06 19:16:53 BRT 2022
