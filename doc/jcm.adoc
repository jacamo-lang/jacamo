...
*  parameters for web inspectors
   - `startWebMindInspector("false")`: disable agent http mind inspector
   - `startWebEnvInspector("false")`: disable environment http inspector
   - `startWebOrgInspector("false")`: disable organisation http inspector
