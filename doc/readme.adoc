...
The starting point for JaCaMo documentation is the https://jacamo-lang.github.io/[JaCaMo web site]. We also have the project dedicated to produce guidelines for https://github.com/jacamo-lang/documentation/[writting documentation] and the https://mitpress.mit.edu/9780262044578/[JaCaMo book].
