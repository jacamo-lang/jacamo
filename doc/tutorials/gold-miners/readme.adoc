...
The slides used at http://altissimo.cs.pub.ro[ALTISSIMO] are found https://github.com/jacamo-lang/jacamo/blob/main/doc/tutorials/gold-miners/aop-altissimo-14.pdf[here].

== Part I

To get started, see http://jacamo-lang.github.io/jacamo/install.html[installation options for JaCaMo] and download the initial JaCaMo project from https://github.com/jacamo-lang/jacamo/raw/refs/heads/main/doc/tutorials/gold-miners/initial-gold-miners.zip[here]. Then, after unziping it into some directory, open the directory in VSCode. You will have a screen like the following
