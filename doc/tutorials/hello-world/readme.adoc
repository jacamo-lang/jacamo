...
http://jacamo.sourceforge.net/eclipseplugin/tutorial/[JaCaMo eclipse plugin] or configure your  http://jacamo.sourceforge.net/tutorial/hello-world/shell-based.html[shell command].
