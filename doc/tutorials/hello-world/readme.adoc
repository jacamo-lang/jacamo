...
http://jacamo.sourceforge.net/eclipseplugin/tutorial/[JaCaMo eclipse plugin] or configure your  http://jacamo.sourceforge.net/tutorial/hello-world/shell-based.html[shell command]. In the eclipse plugin, follow the instructions until step 12. Then, follow the steps
