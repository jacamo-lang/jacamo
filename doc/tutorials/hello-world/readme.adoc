...
NOTE: The keyword `debug` in the definition of the group and of the scheme will start the corresponding organisational inspectors. The url http://localhost:3271 can be used to inspect the organisation state.
